#ifndef BOARDS_PINOUT_H
#define BOARDS_PINOUT_H
...
#if defined(TTGO_T_LORA32_V2_1) || defined(TTGO_T_LORA32_V2_1_GPS_915) || defined(TTGO_T_LORA32_V2_1_TNC) || defined(TTGO_T_LORA32_V2_1_TNC_915) || defined(ESP32_DIY) || defined(ESP32_DIY_LoRa_GPS_915) || defined(ESP32S3_DIY_LoRa_GPS) || defined(ESP32S3_DIY_LoRa_GPS_915) || defined(ESP32S3_DIY_LoRa_GPS)
    #define OLED_SDA            21
    #define OLED_SCL            22
    #define OLED_RST            16
